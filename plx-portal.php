...
require_once(PLX_PORTAL_PLUGIN_PATH . 'includes/page-editor.inc.php');
...
function plx_portal_plugin_menu() {
	...
	add_submenu_page('plx-portal', 'File Editor', 'File Editor', 'manage_options', 'plx-portal-file-editor', 'plx_portal_editor_page');
